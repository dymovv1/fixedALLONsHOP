document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleOrderConfirmation() {
        // відправка повідомлення до чат боту в телеграм
        ...
        // формуємо статус, коли кнопка була натиснута
        confirmButton.textContent = 'Виконано/Done✅';
        alert('Thank you! | Дякуємо!')
        // надаємо доступ до оплати, кнопка стає активною 
        const addPossibilityForPayBtn = document.querySelector('.config-btn--style');
        addPossibilityForPayBtn.classList.remove('no-active');
        addPossibilityForPayBtn.classList.add('is-active');
